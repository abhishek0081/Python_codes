...
from tkinter.constants import FALSE, NONE, RIGHT, TRUE
import os
import pdb 

main_application =tk.Tk()
main_application.geometry("1080x720")
...
def change(event = None):
    ...
    if text_editor.edit_modified():
        ...
        # characters = len(text_editor.get(1.0,"end-1c").replace(" ","")) if you dont want to add spaces
